       ...
       Cookies.get("token")!==undefined?
        ...
        <form className="form-data" onSubmit={updatedData}>
            <div className="form-data-container">
                ...
                <input type="text" required value={name} disabled id="name" className="input-box input-not-allowed"/>
            </div>
             <div className="form-data-container">
                <label htmlFor="email" className="label-data">Email</label>
                <input type="email" required  value={email} disabled id="email" className="input-box input-not-allowed"/>
            </div>
             <div className="form-data-container">
